...
int main()
{
    ...
    strcpy(visores[2].direccion,"Lomas 750");
    visores[2].isEmpty=0;
    strcpy(visores[2].nombre,"Pantalla 3");
    visores[2].precio= 1000.20;
    visores[2].tipo=0;
    ...
    while(opcion!=7)
    {
        getIntInRange(&opcion,"\n1)Alta de pantalla\n2)Modificar datos de pantalla\n3)Baja de pantalla\n"
                      "4)Contratar Publicidad\n5)Mostrar Pantallas\n6)Listar pantallas por precio\n7)Mostrar menor a 10 dias\n\n8)Salir\n\n   INGRESE OPCION: ","ERROR\n",1,10,3);
        switch(opcion)
        {
            case 1:
            {
            ...
            case 6:
            {
                if (flag)
                {
                    ordenarArrayPorPrecio(visores,LEN_LISTA);
            ...
            case 7:
            {
                if (flag)
                {
                    ...
                    mostrarMenorADiez (visores,LEN_LISTA, Marketing,LEN_LISTA);
                }
            }
            break;
            case 8:
