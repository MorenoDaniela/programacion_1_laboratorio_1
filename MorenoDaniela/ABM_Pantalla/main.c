...
int main()
{
    ...
    visores[1].isEmpty=0;
    visores [1].nombre,"Pantalla 2");
    visores [1].precio,"1000.20");
    visores[1].tipo=0;
    visores[1].id=1;

    strcpy(visores [2].direccion,"Mitre 750");
    visores[2].isEmpty=0;
    visores [2].nombre,"Pantalla 3");
    ...
    strcpy(Marketing[1].cuit,"20-20056659-5");
    Marketing[1].dias=30;
    ...
    strcpy(Marketing[2].cuit,"20-20056660-5");
    Marketing[2].dias=30;
